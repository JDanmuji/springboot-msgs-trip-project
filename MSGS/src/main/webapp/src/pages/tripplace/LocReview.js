...
const LocReview = () => {
    return (
        <>
            <div className={[stylesWrap["loc-wrap"], styles["review-container-wrap"]].join(" ")}>
                <div className={[stylesWrap["loc-wrap"], styles["review-container"]].join(" ")} >
                    <div className={styles["review-container-header"]}>
                        <img src="https://assets.triple.guide/images/btn-com-write@2x.png"
                    ...
                    <div className={styles["review-filter-wrap"]}>
                        <div className={styles["review-filter-left"]}>
                            <div aria-selected={true} className={styles["review-filter-select"]}>
                                <span>추천순</span>
                            </div>
                        ...
                        <div className={styles["review-filter-right"]}>
                            ...
                            <div className={styles["review-marker"]}>
                                <img src="https://assets.triple.guide/images/ico_tooltip_info_black@4x.png"
                    ...
                    <div className={styles["review-mileage-btn-wrap"]}>
                        <div className={styles["review-mileage-main-text"]}>리뷰 쓰면 여행자 클럽 최대 3포인트!</div>
                        <div className={[styles["review-mileage-main-text"], styles["review-mileage-sub-text"]].join(" ")}>포인트별 혜택 보기</div>
                        <img alt="포인트별 혜택 보기"
