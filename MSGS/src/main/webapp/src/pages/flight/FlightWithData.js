...
const FlightWithData = () => {
  ...
  async function getData() {
    const url = `http://apis.data.go.kr/1613000/DmstcFlightNvgInfoService/getFlightOpratInfoList?serviceKey=${API_KEY}&pageNo=1&numOfRows=100&_type=json&depAirportId=NAARKJJ&arrAirportId=NAARKPC&depPlandTime=20230403`;
